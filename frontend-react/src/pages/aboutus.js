  ...
  return (
    <div className="relative w-dvw h-dvh overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center items-center h-full backdrop-blur-sm z-10 overflow-hidden">
        {/* Blue Div */}
        <div className="absolute flex justify-center items-center z-20 h-[50%] w-[90%] bg-black/40 top-[170px] border-4 border-sky-200 shadow-[0_0_20px_5px_rgba(135,206,235,0.7)] p-4 rounded-[50px]">
        ...
        {/* About Section */}
        <div className="absolute z-20 top-[29.5%] h-[40%] w-[60%] bg-black/30 border-x-4 border-yellow-200 shadow-[0_0_15px_rgba(255,255,0,0.7)] p-4 flex flex-col items-center">
          ...
          <div className="text-gray-200 px-[60px] tracking-wide text-lg pt-4 overflow-y-scrool">
        ...
        {/* Pink Div */}
        <div className="absolute z-20 top-[0%] md:top-[29.5%] h-auto md:h-[40%] w-[90%] md:w-[65%] border-4 border-pink-300 shadow-[0_0_20px_5px_rgba(300,105,180,0.7)] p-4 bg-transparent overflow-hidden">
  {/* Empty div for future content */}
</div>
